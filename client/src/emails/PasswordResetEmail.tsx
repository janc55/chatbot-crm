  ...
  return (
    <Html className="light" lang="en">
      <Head>
        ...
        <title>Reset Your Password | Nettidev</title>
        ...
        <Container className="email-container bg-background-light dark:bg-[#242424] border-t-4 border-t-[#89c540] shadow-sm rounded-xl overflow-hidden">
          ...
          <Section className="px-8 md:px-12">
            ...
            <Section className="space-y-4 text-center">
              ...
              <Text className="text-slate-600 dark:text-slate-300 text-base leading-relaxed">
                We received a request to reset your password for your Nettidev account. If you didn't make this request, you can safely ignore this email.
              </Text>
            </Section>
          ...
          <Section className="bg-slate-50 dark:bg-[#1e1e1e] px-8 py-10 text-center border-t border-slate-100 dark:border-slate-800">
            ...
            <Text className="text-slate-500 dark:text-slate-400 text-xs leading-5">
              © 2023 Nettidev Software Development Inc.<br />
              123 Tech Lane, Suite 400, San Francisco, CA 94105<br />
              <span className="mt-2 block font-semibold text-slate-400 uppercase tracking-widest text-[10px]">Sent by Nettidev</span>
            </Text>
            <div className="mt-6 flex justify-center items-center gap-2">
              <div className="h-1 w-1 bg-accent-green rounded-full" />
              <Text className="text-[11px] text-slate-400">Secure automated message</Text>
            </div>
          </Section>
        </Container>
